              ...
              child: Column(
                children: [
                  ...
                  Banner(
                    title: 'Amount',
                    value: Constants.rupeeSign +
                        " ${((widget.basePrice + widget.serviceCharge) * widget.taxPercent / 10000) + (widget.basePrice / 100) + (widget.serviceCharge / 100)}",
                  ),
                  SizedBox(
                    height: 10,
                  ),
                            ...
                            return Column(
                              children: [
                                ...
                                Addons(
                                  ...
                                  taxCharge:
                                      widget.addOns[index].addOnTaxCharge,
                                  basePrice:
                                      widget.addOns[index].addOnBasePrice,
                                  serviceCharge:
                                      widget.addOns[index].addOnServiceCharge,
                                  amount: widget.addOns[index].amount,
                                  cashOnDelivery: widget.cashOnDelivery,
                                  quantity: widget.addOns[index].quantity,
                                ),
                              ],
                            );
                          },
                  ...
                  Banner(
                    ...
                    value:
                        Constants.rupeeSign + " ${widget.orderBasePrice / 100}",
                  ),
                  Padding(
                    padding: const EdgeInsets.fromLTRB(16.0, 4, 16, 0),
                    child: Divider(
                  ...
                  Banner(
                    ...
                    value:
                        Constants.rupeeSign + " ${widget.orderTaxCharge / 100}",
                  ),
                  Padding(
                    padding: const EdgeInsets.fromLTRB(16.0, 4, 16, 0),
                    child: Divider(
                  ...
                  Banner(
                    title: 'Discount',
                    value:
                       "- " +Constants.rupeeSign + " ${widget.orderDiscount / 100}",
                  ),
                  SizedBox(
                    height: 10,
                  ),
